...
const servicePresentation: Record<string, Omit<ExperienceItem, 'id' | 'name' | 'description' | 'imageUrl' | 'features'>> = {
  ...
  spa: { amharicName: 'ስፓ እና የውበት እንክብካቤ', category: 'WELLNESS', price: 800, unit: 'starting / session', accent: '#C9828E', href: '/guest/spa', actionLabel: 'Book wellness' },
  'gym-membership': { amharicName: 'ጂም እና የአካል ብቃት', category: 'WELLNESS', price: 500, unit: 'day pass', accent: '#7DBA62', href: '/guest/gym-membership', actionLabel: 'Request access' },
  'pool-passes': { amharicName: 'የመዋኛ ገንዳ', category: 'LEISURE', price: 250, unit: 'day pass / guest', accent: '#5FA7C9', href: '/guest/pool-passes', actionLabel: 'Request pool' },
  'conference-room': { amharicName: 'የስብሰባ ክፍሎች', category: 'EVENTS', price: 3500, unit: 'starting / half day', accent: '#8D9CC8', href: '/guest/conference-room', actionLabel: 'Book space' },
  'multi-purpose-halls': { amharicName: 'ሁለገብ አዳራሾች', category: 'EVENTS', price: 15000, unit: 'starting / day', accent: '#E56B4D', href: '/guest/multi-purpose-halls', actionLabel: 'Book venue' },
  experiences: { amharicName: 'ልዩ የመዝናኛ ተሞክሮዎች', category: 'LEISURE', price: 1000, unit: 'starting / guest', accent: '#86A96B', href: '/guest/experiences', actionLabel: 'Explore experience' },
};
...
function roomItem(room: Room): ExperienceItem {
  return {
    ...
    href: `/guest/rooms/${room.slug || room.id}`,
